...
async def publish_full_state(
    ...
    try:
        ...
        # Легкі агрегати Stage3 для хедера
        ...
        # Stage3 агрегати вже ініціалізовані вище
                ...
                if SOFT_RECOMMENDATIONS_ENABLED:
                    try:
                        ...
                        if can_override_soft:
                            ...
                            # UI-only normalization: map stage2_hint.dir long/short → BUY/SELL
        ...
        # Confidence перцентилі видалені для спрощення payload
        ...
        # analytics/confidence_stats видалені з payload

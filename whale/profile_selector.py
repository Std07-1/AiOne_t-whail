...
def select_profile(
    ...
    # 1) Chop pre-breakout up: часті торкання верхнього краю, слабка акцептація, нахил ≥ 0.6,
    #    присутність ≥ 0.65, |vwap_dev| невеликий. Повертаємо профіль нейтральної гіпотези.
    try:
